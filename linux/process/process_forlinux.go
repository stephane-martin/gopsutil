...
func NewProcess(sshClient *ssh.Client, sftpClient *sftp.Client, pid int) *Process {
	return &Process{
		Pid:        pid,
		sshClient:  sshClient,
...
func (p *Process) ParentWithContext(ctx context.Context) (*Process, error) {
	...
	return NewProcess(p.sshClient, p.sftpClient, p.parent), nil
}
...
func (p *Process) Foreground(sftpClient *sftp.Client) (bool, error) {
	return p.ForegroundWithContext(context.Background(), sftpClient)
}

func (p *Process) ForegroundWithContext(ctx context.Context, sftpClient *sftp.Client) (bool, error) {
	// see https://github.com/stephane-martin/gopsutil/issues/596#issuecomment-432707831 for implementation details
	pid := p.Pid
...
func (p *Process) Uids() ([]int, error) {
	return p.UidsWithContext(context.Background())
}

func (p *Process) UidsWithContext(ctx context.Context) ([]int, error) {
	err := p.fillFromStatus()
	if err != nil {
		return []int{}, err
	}
...
func (p *Process) Gids() ([]int, error) {
	return p.GidsWithContext(context.Background())
}

func (p *Process) GidsWithContext(ctx context.Context) ([]int, error) {
	err := p.fillFromStatus()
	if err != nil {
		return []int{}, err
	}
...
func (p *Process) RlimitUsageWithContext(ctx context.Context, gatherUsed bool) ([]RlimitStat, error) {
	rlimits, err := p.fillFromLimits(p.sftpClient)
	if !gatherUsed || err != nil {
		return rlimits, err
	}

	_, _, _, _, rtprio, _, err := p.fillFromStat()
	if err != nil {
		return nil, err
	}
	if err := p.fillFromStatus(); err != nil {
...
func (p *Process) IOCounters(sftpClient *sftp.Client) (*IOCountersStat, error) {
	return p.IOCountersWithContext(context.Background(), sftpClient)
}

func (p *Process) IOCountersWithContext(ctx context.Context, sftpClient *sftp.Client) (*IOCountersStat, error) {
	return p.fillFromIO(sftpClient)
}
...
func (p *Process) NumThreadsWithContext(ctx context.Context) (int, error) {
	err := p.fillFromStatus()
	if err != nil {
		return 0, err
	}
...
func (p *Process) Threads(client *sftp.Client) (map[int]*cpu.TimesStat, error) {
	return p.ThreadsWithContext(context.Background(), client)
}

func (p *Process) ThreadsWithContext(ctx context.Context, client *sftp.Client) (map[int]*cpu.TimesStat, error) {
	ret := make(map[int]*cpu.TimesStat)
	taskPath := common.HostProc(strconv.Itoa(int(p.Pid)), "task")

	tids, err := readPidsFromDir(client, taskPath)
	if err != nil {
		return nil, err
	}
...
func (p *Process) MemoryInfo(pagesize uint64) (*MemoryInfoStat, error) {
	return p.MemoryInfoWithContext(context.Background(), pagesize)
}

func (p *Process) MemoryInfoWithContext(ctx context.Context, pagesize uint64) (*MemoryInfoStat, error) {
	meminfo, _, err := p.fillFromStatm(pagesize)
	if err != nil {
		return nil, err
	}
	return meminfo, nil
...
func (p *Process) MemoryInfoEx(pagesize uint64) (*MemoryInfoExStat, error) {
	return p.MemoryInfoExWithContext(context.Background(), pagesize)
}

func (p *Process) MemoryInfoExWithContext(ctx context.Context, pagesize uint64) (*MemoryInfoExStat, error) {
	_, memInfoEx, err := p.fillFromStatm(pagesize)
	if err != nil {
		return nil, err
	}
...
func (p *Process) PageFaultsWithContext(ctx context.Context) (*PageFaultsStat, error) {
	_, _, _, _, _, pageFaults, err := p.fillFromStat()
	if err != nil {
		return nil, err
	}
...
func (p *Process) ChildrenWithContext(ctx context.Context) ([]*Process, error) {
	...
	for _, pid := range pids {
		ret = append(ret, NewProcess(p.sshClient, p.sftpClient, pid))
	}
	return ret, nil
}
...
func (p *Process) Connections(sftpClient *sftp.Client) ([]net.ConnectionStat, error) {
	return p.ConnectionsWithContext(context.Background(), sftpClient)
}
...
func (p *Process) ConnectionsMax(sftpClient *sftp.Client, max int) ([]net.ConnectionStat, error) {
	return p.ConnectionsMaxWithContext(context.Background(), sftpClient, max)
}
...
func (p *Process) NetIOCounters(sftpClient *sftp.Client, pernic bool) ([]net.IOCountersStat, error) {
	return p.NetIOCountersWithContext(context.Background(), sftpClient, pernic)
}

func (p *Process) NetIOCountersWithContext(ctx context.Context, sftpClient *sftp.Client, pernic bool) ([]net.IOCountersStat, error) {
	filename := common.HostProc(strconv.Itoa(int(p.Pid)), "net/dev")
	return net.IOCountersByFile(sftpClient, pernic, filename)
}
...
func (p *Process) MemoryMaps(sftpClient *sftp.Client, grouped bool) (*[]MemoryMapsStat, error) {
	return p.MemoryMapsWithContext(context.Background(), sftpClient, grouped)
}

func (p *Process) MemoryMapsWithContext(ctx context.Context, sftpClient *sftp.Client, grouped bool) (*[]MemoryMapsStat, error) {
	pid := p.Pid
	var ret []MemoryMapsStat
	if grouped {
		ret = make([]MemoryMapsStat, 1)
	}
	smapsPath := common.HostProc(strconv.Itoa(pid), "smaps")
	contents, err := common.RemoteReadFile(sftpClient, smapsPath)
	if err != nil {
		return nil, err
	}
...
func (p *Process) fillFromLimits(client *sftp.Client) ([]RlimitStat, error) {
	return p.fillFromLimitsWithContext(context.Background(), client)
}

func (p *Process) fillFromLimitsWithContext(ctx context.Context, client *sftp.Client) ([]RlimitStat, error) {
	pid := p.Pid
	limitsFile := common.HostProc(strconv.Itoa(int(pid)), "limits")
	d, err := client.Open(limitsFile)
	if err != nil {
		return nil, err
	}
	defer d.Close()
...
func (p *Process) fillFromIO(sftpClient *sftp.Client) (*IOCountersStat, error) {
	return p.fillFromIOWithContext(context.Background(), sftpClient)
}

func (p *Process) fillFromIOWithContext(ctx context.Context, sftpClient *sftp.Client) (*IOCountersStat, error) {
	pid := p.Pid
	ioPath := common.HostProc(strconv.Itoa(int(pid)), "io")
	ioline, err := common.RemoteReadFile(sftpClient, ioPath)
	if err != nil {
		return nil, err
	}
...
func (p *Process) fillFromStatm(pagesize uint64) (*MemoryInfoStat, *MemoryInfoExStat, error) {
	return p.fillFromStatmWithContext(context.Background(), pagesize)
}

func (p *Process) fillFromStatmWithContext(ctx context.Context, pagesize uint64) (*MemoryInfoStat, *MemoryInfoExStat, error) {
	pid := p.Pid
...
func (p *Process) fillFromStatusWithContext(ctx context.Context) error {
	...
	contents, err := common.RemoteReadFile(p.sftpClient, statPath)
	if err != nil {
		return err
	}
	lines := strings.Split(string(contents), "\n")
...
func (p *Process) fillFromTIDStat(tid int) (uint64, int32, *cpu.TimesStat, int64, uint32, *PageFaultsStat, error) {
	return p.fillFromTIDStatWithContext(context.Background(), tid)
}

func (p *Process) fillFromTIDStatWithContext(ctx context.Context, tid int) (uint64, int32, *cpu.TimesStat, int64, uint32, *PageFaultsStat, error) {
	pid := p.Pid
	var statPath string

	if tid == -1 {
		statPath = common.HostProc(strconv.Itoa(pid), "stat")
	} else {
		statPath = common.HostProc(strconv.Itoa(pid), "task", strconv.Itoa(tid), "stat")
	}
	...
	cpuTimes := &cpu.TimesStat{
		CPU:    "cpu",
		User:   utime / ClockTicks,
		System: stime / ClockTicks,
	}

	bootTime, err := host.BootTime(p.sftpClient)
	if err != nil {
		return 0, 0, nil, 0, 0, nil, err
	}
	...
	return terminal, int32(ppid), cpuTimes, createTime, uint32(rtpriority), faults, nil
}

func (p *Process) fillFromStat() (uint64, int32, *cpu.TimesStat, int64, uint32, *PageFaultsStat, error) {
	return p.fillFromStatWithContext(context.Background())
}

func (p *Process) fillFromStatWithContext(ctx context.Context) (uint64, int32, *cpu.TimesStat, int64, uint32, *PageFaultsStat, error) {
	return p.fillFromTIDStat(-1)
}

// Pids returns a slice of process ID list which are running now.
func Pids(client *sftp.Client) ([]int, error) {
	return PidsWithContext(context.Background(), client)
}

func PidsWithContext(ctx context.Context, client *sftp.Client) ([]int, error) {
	return readPidsFromDir(client, common.HostProc())
}

// Process returns a slice of pointers to Process structs for all
// currently running processes.
func Processes(sshClient *ssh.Client, sftpClient *sftp.Client) ([]*Process, error) {
	return ProcessesWithContext(context.Background(), sshClient, sftpClient)
}

func ProcessesWithContext(ctx context.Context, sshClient *ssh.Client, sftpClient *sftp.Client) ([]*Process, error) {
	out := []*Process{}
	pids, err := PidsWithContext(ctx, sftpClient)
	if err != nil {
		return out, err
	}
	for _, pid := range pids {
		out = append(out, NewProcess(sshClient, sftpClient, pid))
	}
	return out, nil
}

func readPidsFromDir(client *sftp.Client, path string) ([]int, error) {
	var ret []int
